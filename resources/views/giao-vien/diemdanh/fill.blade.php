                                    ...
                                    <td>
                                        @if (!empty($chiTiet[$item->hs_id]))
                                            @if ($chiTiet[$item->hs_id]->ctdd_trangthai == 1)
                                                <a href="{{ route('giao-vien.check-diem-danh', ['idStudent'=> $item->hs_id,'trangThai' => 0,'idClass' => $item->lh_id]) }}" title="Vắng mặt" class="pd-setting">Có</a>
                                            @else
                                        ...
                                        @else
                                            ...
                                            <a href="{{ route('giao-vien.check-diem-danh', ['idStudent'=> $item->hs_id,'trangThai' => 0,'idClass' => $item->lh_id]) }}" class="ds-setting">Vắng</a>
                                        @endif
                                    </td>
                                    <td>Có || Không</td>
                                    {{-- <td>
